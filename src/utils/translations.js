...
export const translations = {
  en: {
    ...
    service2_title: "Carpentry Works",
    ...
    service6_title: "Brick Wall Works",
    ...
    value2_title: "Integrity & Security",
    value2_description:
    ...
    aboutStartTitle: "How It Started!",
    ...
    safetyHealthPara1:
      "At H&O, we prioritize the safety and health of our employees, clients, and partners. Our commitment to safety is unwavering, ensuring that all projects meet the highest safety standards and practices. We believe that a safe environment is essential for productivity and success, and we continuously invest in training and equipment to protect our teams and our community.",
    safetyHealthPara2:
      "Through rigorous protocols and constant vigilance, we aim to maintain a workspace that fosters well-being and security. Every project adheres to strict health guidelines to safeguard everyone involved, making H&O a leader in responsible and ethical practices.",
    safetyExample1: "Safety precaution example 1",
    safetyExample2: "Safety precaution example 2",
    ...
    alreadyRated: "You have already rated us. Thank you!",
    ...
    tiranaCieloDesc: "Residential Complex in Mjull Bathore near TEG.",
    samiFrasheriTitle: "SAMI FRASHERI",
    samiFrasheriDesc: "Renovation near the center of Tirana.",
    lakeViewTitle: "LAKE VIEW",
    lakeViewDesc: "High-standard building in Tirana.",
    deltaResidenceTitle: "DELTA RESIDENCE",
    deltaResidenceDesc: "High-standard building in Tirana.",
    katedraljaTitle: "KATEDRALJA RINGJALLJA E KRISHTIT",
    katedraljaDesc: "New Orthodox Church in the center of Tirana.",
    hotelLuaniTitle: "HOTEL LUANI ARTE",
    hotelLuaniDesc:
      "The 5-story hotel was built in the city of Shkodra with high standards...",
    spaWellnessTitle: "“LUANI A” SPA & WELLNESS CENTER",
    spaWellnessDesc:
    ...
    deadline: "Deadline",
    jobDetailsNotFound: "Job details not found",
    ...
    responsibilityConstructionEngineer1:
      "Plan, design, and supervise construction projects from start to finish.",
    ...
    responsibilityConstructionWorker1:
      "Assist in concrete mixing, site preparation, and material handling.",
    responsibilityConstructionWorker2:
      "Follow blueprints and project instructions accurately.",
    responsibilityConstructionWorker3: "Operate hand and power tools safely.",
    responsibilityConstructionWorker4:
      "Ensure compliance with safety and health guidelines on site.",
    requirementConstructionWorker1:
      "Previous experience in construction or related work preferred.",
    requirementConstructionWorker2:
      "Ability to perform physical labor and work outdoors.",
    requirementConstructionWorker3: "Strong teamwork and reliability.",
    ...
    responsibilityConstructionForeman1:
      "Supervise construction workers and subcontractors on site.",
    ...
    responsibilityConstructionForeman3:
      "Ensure that safety and quality standards are met.",
    responsibilityConstructionForeman4:
      "Coordinate daily activities and resolve on-site issues promptly.",
    ...
    requirementConstructionForeman3:
      "Excellent knowledge of construction processes and safety practices.",
    ...
    responsibilityConstructionArchaeologist1:
      "Conduct archaeological assessments before and during construction.",
    ...
    responsibilityConstructionArchaeologist3:
      "Collaborate with site managers to minimize site impact.",
    responsibilityConstructionArchaeologist4:
      "Ensure legal compliance with heritage conservation standards.",
    ...
    requirementConstructionArchaeologist3:
      "Ability to work collaboratively on active construction sites.",
    ...
    responsibilityArchitecturalDesigner1:
      "Develop design concepts and 3D visualizations.",
    ...
    responsibilityArchitecturalDesigner4:
      "Ensure designs comply with local regulations and sustainability goals.",
    ...
    requirementArchitecturalDesigner3:
      "Strong design portfolio showcasing creativity and technical ability.",
    ...
    responsibilityProjectCoordinator1:
      "Assist in scheduling, budgeting, and reporting.",
    responsibilityProjectCoordinator2:
      "Communicate project progress with stakeholders.",
    responsibilityProjectCoordinator3:
      "Maintain project documentation and contracts.",
    responsibilityProjectCoordinator4:
      "Support the project manager in day-to-day activities.",
    requirementProjectCoordinator1:
      "Bachelor’s degree in Management, Engineering, or similar field.",
    ...
    responsibilityStructuralEngineer1:
      "Develop structural designs and calculations.",
    responsibilityStructuralEngineer2:
      "Review architectural drawings for structural integrity.",
    responsibilityStructuralEngineer3:
      "Collaborate with construction and design teams.",
    responsibilityStructuralEngineer4:
      "Conduct site inspections and issue compliance reports.",
    requirementStructuralEngineer1:
      "Degree in Structural or Civil Engineering.",
    requirementStructuralEngineer2:
      "Strong knowledge of Eurocodes and design standards.",
    ...
    responsibilityInstallationForeman1:
      "Plan and oversee installation activities on site.",
    ...
    quality: "Quality",
    pricePerM2: "Price / m² (€)",
    workerPerM2: "Worker / m² (€)",
    transportPerM2: "Transport / m² (€)",
    discount: "Discount (%)",
    tax: "Tax (%)",
    ...
    Sand: "Sand",
    "Clean and fine sand ideal for masonry and plastering.":
      "Clean and fine sand ideal for masonry and plastering.",

    Cement: "Cement",
    "High-quality cement for strong and durable structures.":
      "High-quality cement for strong and durable structures.",
    ...
    "Pipes & Plumbing Materials": "Pipes & Plumbing Materials",
    ...
    Stone: "Stone",
    "Natural stone for landscaping, paving, and structural use.":
      "Natural stone for landscaping, paving, and structural use.",
    ...
    noResults: "Sorry, we could not find any matching questions.",
    ...
    faq_project_1_q: "How do I start a construction project?",
    faq_project_1_a:
      'Fill out the project form under "Services", and our team will contact you.',

    faq_project_2_q: "How can I track my project progress?",
    faq_project_2_a:
      "Once registered, you can track your project progress in your profile.",

    faq_project_3_q: "Can I request multiple projects at once?",
    faq_project_3_a:
      "Yes, you can submit multiple project requests, and our team will manage them efficiently.",

    faq_project_4_q: "Do you provide consultation before starting?",
    faq_project_4_a:
      "Absolutely, we offer free consultation to discuss your requirements.",

    faq_project_5_q: "How long does a typical project take?",
    faq_project_5_a:
      "Project timelines depend on the scope, but we provide estimated durations for each project.",

    faq_project_6_q: "Can I customize the design?",
    faq_project_6_a:
    ...
    faq_payment_2_q: "Are official contracts provided?",
    faq_payment_2_a:
      "Yes, every project comes with an official contract for transparency and security.",

    faq_payment_3_q: "Can I get a refund if needed?",
    faq_payment_3_a:
      "Refunds are processed according to the contract terms agreed upon before starting the project.",

    faq_payment_4_q: "Do you offer installment payments?",
    faq_payment_4_a:
      "Yes, payment installments are available for eligible projects.",

    faq_payment_5_q: "Are invoices provided?",
    faq_payment_5_a:
    ...
    faq_support_2_q: "What are your working hours?",
    faq_support_2_a: "Monday to Friday, 8:00 AM - 5:00 PM.",

    faq_support_3_q: "Do you offer online support?",
    faq_support_3_a: "Yes, our support team is available via email and chat.",

    faq_support_4_q: "Can I schedule a site visit?",
    faq_support_4_a:
      "Yes, schedule a site visit through the contact form or by calling us.",

    faq_support_5_q: "Is emergency support available?",
    faq_support_5_a:
      "Yes, emergency support is available for ongoing projects.",
  },
  ...
  sq: {
    ...
    service2_title: "Punime Druri",
    service2_description:
      "Druvarët tanë krijojnë punime druri të cilësisë së lartë, duke përfshirë kornizat, çatitë dhe mobiliet e personalizuara sipas nevojave tuaja.",
    service3_title: "Punime Hekuri",
    service3_description:
      "Specializojmë në punime hekuri të qëndrueshme dhe precize, përfshirë porta, gardhe dhe mbështetëse strukturore.",
    service4_title: "Punime Betoni",
    service4_description:
      "Ofrojmë një gamë shërbimesh betoni, nga themelet deri te finishet dekorative, për ndërtesa rezidenciale dhe komerciale.",
    service5_title: "Punime Çatie",
    service5_description:
      "Ekspertët tanë të çative sigurojnë çati të qëndrueshme dhe të besueshme, duke trajtuar instalime, riparime dhe zëvendësime.",
    service6_title: "Punime Muri Tulli",
    service6_description:
      "Ndërtojmë dhe riparojmë mure tullash me precizion, duke shtuar integritet strukturor dhe vlerë estetike për pronën tuaj.",
    service7_title: "Punime Suvatimi",
    service7_description:
      "Shërbimet tona të suvatimit ofrojnë finishe të lëmuara dhe të qëndrueshme për sipërfaqe të brendshme dhe të jashtme, duke përmirësuar hapësirën tuaj.",
    service8_title: "Punime Fasade",
    service8_description:
      "Transformoni pamjen e ndërtesës tuaj me shërbimet tona të ekspertizës për fasadat, përfshirë restaurimin, instalimin dhe mbulimin.",
    service9_title: "Sisteme Tenda",
    service9_description:
      "Projektimi dhe instalimi i sistemeve të tendave funksionale, duke siguruar strehim dhe pamje estetike për pronën tuaj.",
    service10_title: "Fasada të Ventiluara",
    service10_description:
      "Fasadat tona të ventiluara përmirësojnë efikasitetin e energjisë dhe qarkullimin e ajrit, duke i dhënë një pamje moderne ndërtesës suaj.",
    service11_title: "Punime Mozaik",
    service11_description:
      "Shërbimet tona të mozaikut përfshijnë gjithçka nga dyshemeja deri te muret, duke ofruar stile të ndryshme dhe instalime të cilësisë së lartë.",
    service12_title: "Punime Dekorative",
    service12_description:
      "Specializoheni në mbulesa dekorative që përmirësojnë pamjen dhe ndjesinë e hapësirës suaj, duke kombinuar bukurinë me mbrojtjen.",
    service13_title: "Punime Rinovimi",
    service13_description:
      "Shërbimet tona të rinovimit transformojnë hapësira ekzistuese, duke përmirësuar interierin dhe eksterierin sipas standardeve moderne.",
    service14_title: "Punime Hidraulike",
    service14_description:
      "Nga instalimet deri te riparimet, shërbimet tona hidraulike mbulojnë gjithçka nga tubat te pajisjet, duke siguruar një sistem të funksionueshëm.",
    service15_title: "Punime Izolimi",
    service15_description:
      "Ofrojmë zgjidhje izolimi për të përmirësuar efikasitetin e energjisë, reduktuar zhurmën dhe krijuar ambiente të rehatshme.",
    service16_title: "Punime Elektrike",
    service16_description:
    ...
    value2_title: "Integritet & Siguria",
    value2_description:
      "Përmbushim premtimin e misionit tonë përmes sjelljes që reflekton ndershmëri, përgjegjësi dhe drejtësi në veprim.",
    ...
    aboutIntro:
      "H&O është një kompani ndërtimi me një reputacion të gjerë dhe të shkëlqyer, e ndërtuar mbi vlerat e shkëlqimit dhe integritetit, e provuar gjatë viteve.",
    aboutProjects:
      "Gjatë viteve, H&O ka përfunduar shumë projekte në fushën e ndërtimit civil dhe industrial, si ndërtesa banimi, ndërtimi industrial dhe infrastruktural, qendra sociale dhe kulturore, në bashkëpunim me kompani të ndryshme prestigjioze në Shqipëri.",
    aboutStartTitle: "Si Filloi!",
    aboutStartDescription:
      "E themeluar në 2002 si një biznes individual i fokusuar në ndërtimin dhe rindërtimin e ndërtesave banimi dhe tregtinë e materialeve ndërtimore, H&O ka rritur shpejt në një kompani ambicioze që ofron punë cilësore duke qenë inovative, e besueshme dhe e përkushtuar ndaj shkëlqimit.",
    totalProjects: "Projektet Totale",
    completed: "Të Përfunduara",
    inProgress: "Në Progres",
    safetyHealth: "Siguria dhe Shëndeti",
    safetyHealthPara1:
      "Tek H&O, ne i japim përparësi sigurisë dhe shëndetit të punonjësve, klientëve dhe partnerëve tanë. Angazhimi ynë ndaj sigurisë është i palëkundur, duke siguruar që të gjitha projektet të përmbushin standardet më të larta të sigurisë dhe praktikat më të mira.",
    safetyHealthPara2:
      "Përmes protokolleve rigoroze dhe vigjilencës së vazhdueshme, ne synojmë të ruajmë një ambient pune që promovon mirëqenien dhe sigurinë. Çdo projekt i përmbahet udhëzimeve strikte të shëndetit për të mbrojtur të gjithë të përfshirët, duke e bërë H&O lider në praktikat e përgjegjshme dhe etike.",
    safetyExample1: "Shembull sigurie 1",
    ...
    User: "Përdorues",
    logout: "Dil",
    loginFailed: "Dështoi logimi",
    shareExperience: "Shpreh përvojën tuaj",
    feedbackDesc: "Na tregoni mendimin tuaj — komenti juaj ka rëndësi.",
    leaveComment: "Lini një koment...",
    submitRating: "Dërgo Vlerësimin",
    alreadyRated: "Ju keni vlerësuar tashmë. Faleminderit!",
    ...
    tiranaCieloTitle: "TIRANA CIELO",
    tiranaCieloDesc: "Kompleks rezidencial në Mjull Bathore pranë TEG.",
    samiFrasheriTitle: "SAMI FRASHERI",
    samiFrasheriDesc: "Rinovim pranë qendrës së Tiranës.",
    lakeViewTitle: "LAKE VIEW",
    lakeViewDesc: "Ndërtesë me standard të lartë në Tiranë.",
    deltaResidenceTitle: "DELTA RESIDENCE",
    deltaResidenceDesc: "Ndërtesë me standard të lartë në Tiranë.",
    katedraljaTitle: "KATEDRALJA RINGJALLJA E KRISHTIT",
    katedraljaDesc: "Kishë e re ortodokse në qendër të Tiranës.",
    hotelLuaniTitle: "HOTEL LUANI ARTE",
    hotelLuaniDesc:
      "Hoteli 5-katësh u ndërtua në qytetin e Shkodrës me standard të lartë...",
    spaWellnessTitle: "“LUANI A” SPA & WELLNESS CENTER",
    spaWellnessDesc:
    ...
    yourApplications: "Aplikimet Tuaja",
    jobTitle: "Pozicioni",
    appliedOn: "Aplikuar më",
    status: "Statusi",
    pending: "Në pritje",
    closed: "Mbyllur",
    noApplicationsYet: "Nuk keni aplikuar ende për ndonjë punë",
    responsibilities: "Detyrat",
    requirements: "Kërkesat",
    deadline: "Afati",
    jobDetailsNotFound: "Detajet e punës nuk u gjetën",
    fillAllFields:
      "Ju lutem plotësoni të gjitha fushat dhe ngarkoni CV-në tuaj.",
    Submit: "Dergo",
    ...
    responsibilityConstructionEngineer1:
      "Planifikoni, dizajnoni dhe mbikëqyrni projektet e ndërtimit nga fillimi deri në fund.",
    responsibilityConstructionEngineer2:
      "Përgatitni vlerësimet e kostove, buxhetet dhe afatet kohore.",
    responsibilityConstructionEngineer3:
      "Bashkëpunoni me arkitektët, kontraktorët dhe palët e interesuara.",
    responsibilityConstructionEngineer4:
      "Siguroni përputhshmëri me kodet e ndërtimit dhe rregulloret e sigurisë.",
    requirementConstructionEngineer1:
      "Diplomë bachelor në Inxhinieri Civile ose Ndërtimi.",
    requirementConstructionEngineer2:
      "Minimum 3 vjet përvojë në menaxhimin e projekteve të ndërtimit.",
    requirementConstructionEngineer3:
      "Aftësi të shkëlqyera në zgjidhjen e problemeve dhe komunikim.",
    requirementConstructionEngineer4:
    ...
    responsibilityConstructionWorker1:
      "Ndihmoni në përzierjen e betonit, përgatitjen e vendit dhe trajtimin e materialeve.",
    responsibilityConstructionWorker2:
      "Ndjekni me saktësi planet dhe udhëzimet e projektit.",
    responsibilityConstructionWorker3:
      "Përdorni me siguri veglat manuale dhe elektrike.",
    responsibilityConstructionWorker4:
      "Siguroni përputhshmëri me udhëzimet e sigurisë dhe shëndetit në vend.",
    requirementConstructionWorker1:
      "Përvojë e mëparshme në ndërtim ose punë të ngjashme e preferuar.",
    requirementConstructionWorker2:
      "Aftësi për të kryer punë fizike dhe për të punuar jashtë.",
    requirementConstructionWorker3: "Puna në grup dhe besueshmëri e fortë.",
    requirementConstructionWorker4:
    ...
    responsibilityConstructionForeman1:
      "Mbikëqyr punëtorët e ndërtimit dhe nënkontraktorët në vend.",
    responsibilityConstructionForeman2:
      "Monitoron progresin e projektit dhe raporton tek menaxheri i projektit.",
    responsibilityConstructionForeman3:
      "Siguron që standardet e sigurisë dhe cilësisë të zbatohen.",
    responsibilityConstructionForeman4:
      "Koordinon aktivitetet ditore dhe zgjidh çështjet në vend shpejt.",
    requirementConstructionForeman1:
      "Përvojë e provuar si Kryeinspektor ose rol mbikëqyrës i ngjashëm.",
    requirementConstructionForeman2:
      "Aftësi të forta udhëheqëse dhe komunikimi.",
    requirementConstructionForeman3:
      "Njohuri të shkëlqyera të proceseve të ndërtimit dhe praktikave të sigurisë.",
    requirementConstructionForeman4:
    ...
    responsibilityConstructionArchaeologist1:
      "Kryeni vlerësime arkeologjike para dhe gjatë ndërtimit.",
    responsibilityConstructionArchaeologist2:
      "Dokumentoni gjetjet dhe përgatitni raporte të detajuara.",
    responsibilityConstructionArchaeologist3:
      "Bashkëpunoni me menaxherët e vendit për të minimizuar ndikimin në vend.",
    responsibilityConstructionArchaeologist4:
      "Siguroni përputhshmëri ligjore me standardet e ruajtjes së trashëgimisë.",
    requirementConstructionArchaeologist1:
      "Diplomë në Arkeologji, Antropologji ose fushë të ngjashme.",
    requirementConstructionArchaeologist2:
      "Aftësi të forta kërkimore dhe dokumentuese.",
    requirementConstructionArchaeologist3:
      "Aftësi për të punuar bashkëpunueshëm në vendet aktive të ndërtimit.",
    requirementConstructionArchaeologist4:
    ...
    responsibilityArchitecturalDesigner1:
      "Zhvilloni konceptet e dizajnit dhe vizualizime 3D.",
    responsibilityArchitecturalDesigner2:
      "Bashkëpunoni me ekipet e inxhinierisë dhe menaxherët e projektit.",
    responsibilityArchitecturalDesigner3:
      "Përgatitni vizatime teknike dhe specifikime.",
    responsibilityArchitecturalDesigner4:
      "Siguroni që dizajnet të përputhen me rregulloret lokale dhe qëllimet e qëndrueshmërisë.",
    requirementArchitecturalDesigner1:
      "Diplomë bachelor në Arkitekturë ose fushë të ngjashme.",
    requirementArchitecturalDesigner2:
      "Njohuri në AutoCAD, SketchUp ose Revit.",
    requirementArchitecturalDesigner3:
      "Portofol i fortë dizajni që tregon kreativitet dhe aftësi teknike.",
    requirementArchitecturalDesigner4:
    ...
    responsibilityProjectCoordinator1:
      "Ndihmoni në planifikimin, buxhetimin dhe raportimin.",
    responsibilityProjectCoordinator2:
      "Komunikoni progresin e projektit me palët e interesuara.",
    responsibilityProjectCoordinator3:
      "Mbani dokumentacionin e projektit dhe kontratat.",
    responsibilityProjectCoordinator4:
      "Mbështesni menaxherin e projektit në aktivitetet ditore.",
    requirementProjectCoordinator1:
      "Diplomë bachelor në Menaxhim, Inxhinieri ose fushë të ngjashme.",
    requirementProjectCoordinator2:
      "Aftësi të forta organizative dhe multitasking.",
    requirementProjectCoordinator3:
    ...
    responsibilityStructuralEngineer1:
      "Zhvilloni dizajne dhe llogaritje strukturore.",
    responsibilityStructuralEngineer2:
      "Rishikoni vizatimet arkitekturore për integritet struktural.",
    responsibilityStructuralEngineer3:
      "Bashkëpunoni me ekipet e ndërtimit dhe dizajnit.",
    responsibilityStructuralEngineer4:
      "Kryeni inspektime në vend dhe lëshoni raporte për përputhshmëri.",
    requirementStructuralEngineer1:
      "Diplomë në Inxhinieri Struktural ose Civile.",
    requirementStructuralEngineer2:
      "Njohuri të forta të Eurocodes dhe standardeve të dizajnit.",
    requirementStructuralEngineer3:
      "Përvojë me softuerët e analizës strukturore.",
    requirementStructuralEngineer4:
    ...
    responsibilityInstallationForeman1:
      "Planifikoni dhe mbikëqyrni aktivitetet e instalimit në vend.",
    responsibilityInstallationForeman2:
      "Mbikëqyrni teknikët dhe nënkontraktorët.",
    responsibilityInstallationForeman3:
      "Siguroni cilësi dhe përputhshmëri me standardet teknike.",
    responsibilityInstallationForeman4:
      "Monitoroni progresin dhe raportoni devijimet tek menaxhimi.",
    requirementInstallationForeman1:
      "Diplomë teknike në Inxhinieri ose fushë të ngjashme.",
    requirementInstallationForeman2:
      "Minimum 3 vjet përvojë si Kryeinspektor Instalimi.",
    requirementInstallationForeman3:
    ...
    quality: "Cilësia",
    pricePerM2: "Çmimi / m² (€)",
    workerPerM2: "Punëtori / m² (€)",
    transportPerM2: "Transporti / m² (€)",
    discount: "Zbritja (%)",
    tax: "Taksa (%)",
    ...
    essentialCookies: "Cookies esenciale",
    ...
    formSubmitted: "Aplikimi u dërgua!",
    ...
    prev: "Mëparshëm",
    next: "Tjetër",
    addNewEvent: "Shto Ngjarje të Re",
    ...
    Wood: "Druri",
    "Premium quality wood for construction and design, offering durability and aesthetic appeal.":
      "Druri me cilësi të lartë për ndërtim dhe dizajn, ofron qëndrueshmëri dhe estetikë.",

    Concrete: "Betoni",
    "High-grade concrete for strong foundations and sustainable structures.":
      "Beton i klasit të lartë për themele të forta dhe struktura të qëndrueshme.",

    Steel: "Çeliku",
    "Robust and corrosion-resistant steel for architectural and industrial applications.":
      "Çelik i fortë dhe i qëndrueshëm për aplikime arkitekturore dhe industriale.",

    Glass: "Qelqi",
    "Crystal-clear glass for modern and sleek designs, ensuring durability and style.":
      "Qelq i pastër për dizajne moderne dhe elegante, i qëndrueshëm dhe stilist.",

    Tiles: "Tegela",
    "Elegant tiles with diverse patterns, perfect for interior and exterior spaces.":
      "Tegela elegante me modele të ndryshme, perfekte për hapësira të brendshme dhe të jashtme.",

    Granite: "Graniti",
    "Durable and elegant granite for countertops, flooring, and other construction needs.":
      "Graniti i qëndrueshëm dhe elegant për banakë, dysheme dhe nevoja të tjera ndërtimi.",

    Brick: "Tullat",
    "Reliable and affordable bricks for traditional and modern building projects.":
      "Tulla të besueshme dhe të përballueshme për projekte ndërtimi tradicionale dhe moderne.",

    Marble: "Mermeri",
    "Luxurious marble for sophisticated interiors and exteriors.":
      "Mermer luksoz për brendësi dhe jashtësi të sofistikuara.",

    Aluminum: "Alumini",
    "Lightweight and versatile aluminum for construction and design.":
      "Alumini i lehtë dhe fleksibël për ndërtim dhe dizajn.",

    PVC: "PVC",
    "Cost-effective and durable PVC for pipes, windows, and more.":
      "PVC me kosto të ulët dhe i qëndrueshëm për tuba, dritare dhe më shumë.",

    Sand: "Rërë",
    "Clean and fine sand ideal for masonry and plastering.":
      "Rërë e pastër dhe e imët ideale për muraturë dhe gipsim.",

    Cement: "Cementi",
    "High-quality cement for strong and durable structures.":
      "Cement i cilësisë së lartë për struktura të forta dhe të qëndrueshme.",

    Plasterboard: "Tavane gipsi",
    "Efficient and easy-to-install plasterboard for walls and ceilings.":
      "Plafon gipsi i lehtë për t’u instaluar për mure dhe tavan.",

    Asphalt: "Asfalti",
    "Reliable asphalt for durable and smooth roads and pavements.":
      "Asfalt i besueshëm për rrugë dhe trotuare të qëndrueshme dhe të lëmuara.",

    "Insulation Materials": "Materiale Izoluese",
    "Thermal and acoustic insulation for energy-efficient buildings.":
      "Izolim termik dhe akustik për ndërtesa energjetikisht efikase.",

    "Roofing Materials": "Materiale Mbulesash",
    "Durable and weather-resistant roofing materials for all building types.":
      "Materiale mbulesash të qëndrueshme dhe rezistente ndaj motit për të gjitha llojet e ndërtesave.",

    "Adhesives & Sealants": "Ngjitës dhe Sigurues",
    "High-quality adhesives and sealants for secure bonding and sealing.":
      "Ngjitës dhe siguresa me cilësi të lartë për lidhje dhe vulosje të sigurt.",

    Ceramics: "Qeramika",
    "Aesthetic and durable ceramics for interior and exterior applications.":
      "Qeramika estetike dhe e qëndrueshme për aplikime të brendshme dhe të jashtme.",

    Gypsum: "Gipsi",
    "Versatile gypsum for walls, ceilings, and decorative applications.":
      "Gips i shumëfishtë për mure, tavane dhe aplikime dekorative.",

    "Paints & Coatings": "Ngjyra dhe Llak",
    "Wide range of paints and coatings for protective and decorative finishes.":
      "Gama e gjerë e ngjyrave dhe llaqeve për përfundime mbrojtëse dhe dekorative.",

    "Pipes & Plumbing Materials": "Tuba dhe Pajisje Hidraulike",
    "Durable pipes and fittings for water supply and drainage systems.":
      "Tuba dhe pajisje hidraulike të qëndrueshme për furnizim me ujë dhe sistem kanalizimi.",

    "Electrical Materials": "Materiale Elektrike",
    "Cables, switches, and other electrical materials for residential and industrial use.":
      "Kabuj, çelësa dhe materiale të tjera elektrike për përdorim rezidencial dhe industrial.",

    Timber: "Druri i Përpunuar",
    "Natural and engineered timber for construction and furniture.":
      "Druri natyror dhe i përpunuar për ndërtim dhe mobilje.",

    Stone: "Guri",
    "Natural stone for landscaping, paving, and structural use.":
      "Gur natyror për landscaping, trotuar dhe përdorim strukturor.",

    "Metal Sheets": "Fletë Metalike",
    "High-quality metal sheets for roofing and industrial applications.":
      "Fletë metalike me cilësi të lartë për mbulesa dhe aplikime industriale.",

    "Composite Materials": "Materiale Kompozite",
    "Innovative composite materials for strength and lightweight construction.":
      "Materiale kompozite inovative për forcë dhe ndërtim të lehtë.",
    ...
    noResults: "Na vjen keq, nuk u gjetën pyetje të përputhshme.",
    needAssistance: "Keni nevojë për më shumë ndihmë?",
    contactMessage:
      "Kontaktoni ekipin tonë të mbështetjes dhe do t'ju përgjigjemi sa më shpejt të jetë e mundur.",
    "Projects & Services": "Projektet & Shërbimet",
    ...
    faq_project_2_q: "Si mund të ndjek progresin e projektit tim?",
    faq_project_2_a:
      "Pasi të regjistroheni, mund të ndiqni progresin e projektit në profilin tuaj.",

    faq_project_3_q: "A mund të kërkoj disa projekte njëherësh?",
    faq_project_3_a:
      "Po, mund të dorëzoni disa kërkesa projektesh, dhe ekipi ynë do t'i menaxhojë me efikasitet.",

    faq_project_4_q: "A ofroni konsultim para fillimit?",
    faq_project_4_a:
      "Patjetër, ne ofrojmë konsultim falas për të diskutuar kërkesat tuaja.",

    faq_project_5_q: "Sa zgjat një projekt tipik?",
    faq_project_5_a:
      "Koha e projekteve varet nga shkalla e tyre, por ne japim kohëzgjatje të llogaritura për çdo projekt.",

    faq_project_6_q: "A mund të personalizoj dizajnin?",
    faq_project_6_a:
    ...
    faq_payment_2_q: "A ofrohen kontrata zyrtare?",
    faq_payment_2_a:
      "Po, çdo projekt vjen me kontratë zyrtare për transparencë dhe siguri.",

    faq_payment_3_q: "A mund të marr rimbursim nëse është e nevojshme?",
    faq_payment_3_a:
      "Rimbursimet përpunohen sipas kushteve të kontratës që janë dakorduar para fillimit të projektit.",

    faq_payment_4_q: "A ofroni pagesa me këste?",
    faq_payment_4_a:
      "Po, pagesa me këste është e disponueshme për projektet e kualifikuara.",

    faq_payment_5_q: "A ofrohen fatura?",
    faq_payment_5_a:
    ...
    faq_support_2_q: "Cilat janë oraret tuaja të punës?",
    faq_support_2_a: "E hënë deri të premte, 08:00 - 17:00.",

    faq_support_3_q: "A ofroni mbështetje online?",
    faq_support_3_a:
      "Po, ekipi ynë i mbështetjes është në dispozicion përmes email dhe chat.",

    faq_support_4_q: "A mund të planifikoj një vizitë në vendin e ndërtimit?",
    faq_support_4_a:
      "Po, planifikoni një vizitë në vend përmes formularit të kontaktit ose duke na telefonuar.",

    faq_support_5_q: "A ofrohet mbështetje emergjente?",
    faq_support_5_a:
      "Po, mbështetje emergjente është në dispozicion për projektet aktuale.",
  },
};
